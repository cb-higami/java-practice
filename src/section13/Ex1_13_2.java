...
public class Ex1_13_2 {
    public static void main(String[] args) {
        ...
        checkPersonalityFromBloodType(1);
        checkPersonalityFromBloodType(2);
        checkPersonalityFromBloodType(3);
        checkPersonalityFromBloodType(4);
        checkPersonalityFromBloodType(5);


    }

    static  void checkPersonalityFromBloodType(int bloodType) {
        switch (bloodType) {
            case 1:
